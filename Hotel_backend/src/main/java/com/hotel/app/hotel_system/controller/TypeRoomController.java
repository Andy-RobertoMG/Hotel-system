...
public class TypeRoomController {
  ...
  // }
    ...
    public ResponseEntity<RoomTypeDTO> guardar(@RequestBody @Valid RoomType roomtype)
    {
    ...
    // }
      ...
      RoomType objeto =  rt_service.insertarRT(roomtype);
      RoomTypeDTO objeto_ = new RoomTypeDTO(objeto);
      Message message = new Message("La habitación se ha creado exitosamente");
      return new ResponseEntity<RoomTypeDTO>(objeto_, HttpStatus.OK);
   ...
   public ResponseEntity<Message> delete(@PathVariable UUID id) throws TypeRoomFoundException
   {
   ...
   public ResponseEntity<RoomTypeDTO> update(@RequestBody RoomType roomtype, @PathVariable UUID id) throws RoomTypeNotFoundException{
    RoomType RT = rt_service.searchRoomType(id);
    RoomType pass = rt_service.insertarRT(roomtype);
    RoomTypeDTO dad = new RoomTypeDTO(pass);
    return new ResponseEntity<RoomTypeDTO>(dad,HttpStatus.OK);
    // if(pass.){
